...
<p style="color:darkblue; text-align:left;">
  ...
  <ul>
    <li><strong>Theory:</strong> refined algorithm <em>(work in progress)</em></li>
    ...
    <li><strong>Robustness:</strong> address uncertainty in system configurations, adapt to dynamic environments</li>
