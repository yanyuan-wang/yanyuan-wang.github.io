...
- **Reliability:** ensure behaviorally aligned system *(work in progress)*  
- **Efficiency:** achieve computational speedups for large-scale system *(work in progress)*  
...
By a change of viewpoint, the estimation of risk functional of coneditional expectation is converted into a ML task.
